<?php
    class Sphere
    {
        ...
        function __construct($name, $color, $id, $path)
        {
            $this -> name = $name;
            $this -> color = $color;
            $this -> xp = 0;
        ...
        function printForEditing()
        {
            ...
            <section class="swiper-slide">
                <form method="post" action="<? echo $this->path ?>/components/editSpheresComp.php" class="sphere">
                    <div class="sphere-header" sphereID="<?php echo $this->id ?>" sphereName="<?php echo $this->name ?>" style="background-color: <?php echo $this->color ?> !important;">
                        <label>
                            <img src="<? echo $this->path ?>/imgs/icons/colorIcon.svg" width="30"/>
                    ...
                    <div class="sphere-inputs">
                        ...
                        <div class="sphere-adding-inputs">
                            <table>
                                <tr>
                                    <td>
                                        <img src="<? echo $this->path ?>/imgs/icons/question.svg" style="max-width:100%;" class="hint-img">
